      ...
      else if(rightCell == -5)
      {
          ...
          {  
            if(g->idup[icell]==2)
            {
              ...
              g->fv[j][0] = g->dpsil[c1][0];
              g->fv[j][1] = g->dpsil[c1][1]; 
              g->fv[j][2] = g->dpsil[c1][2]; 
              g->fv[j][3] = g->dpsil[c1][3];
              g->fv[j][4] = g->dpsil[c1][4];
            }
            else
            {
              ...
              g->fv[j][0] = g->psil[icell][0];
              g->fv[j][1] = g->psil[icell][1]; 
              g->fv[j][2] = g->psil[icell][2]; 
              g->fv[j][3] = g->psil[icell][3];
              g->fv[j][4] = g->psil[icell][4];
            }
            }
            ...
            if(g->idup[icell]==2)
            {
              ...
              g->fv[j][0] = g->dpsila[c1][0];
              g->fv[j][1] = g->dpsila[c1][1]; 
              g->fv[j][2] = g->dpsila[c1][2]; 
              g->fv[j][3] = g->dpsila[c1][3];
              g->fv[j][4] = g->dpsila[c1][4];
            ...
            else
            {
              ...
              g->fv[j][0] = g->psila[icell][0];
              g->fv[j][1] = g->psila[icell][1]; 
              g->fv[j][2] = g->psila[icell][2]; 
              g->fv[j][3] = g->psila[icell][3];
              g->fv[j][4] = g->psila[icell][4];
          ...
          if(order==5 && (j==0 || j==chainSize-1))
          {
            if(g->idup[icell]==2)
            {
              ...
              g->fv[j][0] = g->dpsilb[c1][0];
              g->fv[j][1] = g->dpsilb[c1][1]; 
              g->fv[j][2] = g->dpsilb[c1][2]; 
              g->fv[j][3] = g->dpsilb[c1][3];
              g->fv[j][4] = g->dpsilb[c1][4];
            ...
            else
            {
              ...
              g->fv[j][0] = g->psilb[icell][0];
              g->fv[j][1] = g->psilb[icell][1]; 
              g->fv[j][2] = g->psilb[icell][2]; 
              g->fv[j][3] = g->psilb[icell][3];
              g->fv[j][4] = g->psilb[icell][4];
            }
          }
