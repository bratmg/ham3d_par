...
typedef struct GRID
{
  ...
  int *icommu,*iadjp,*istp, *ilengp, *isend, *irecv, *irecvconn, *irecvconn2, *idup;
  double **psil, **psila, **dpsil, **dpsila, **psilb, **dpsilb;
  double **psil_deri, **psila_deri, **dpsil_deri, **dpsila_deri, **psilb_deri,**dpsilb_deri;
